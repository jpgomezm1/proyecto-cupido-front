    ...
    try:
        ...
        query = f"""
            SELECT
                ...
                p.latitud as lat,
                p.longitud as lng,
                COALESCE(p.ubicacion_aproximada, TRUE) as location_approximate,
        ...
        for prop in properties:
            ...
            prop_dict = {
                ...
                'lat': prop.get('lat'),
                'lng': prop.get('lng'),
                'location_approximate': bool(prop.get('location_approximate')) if prop.get('location_approximate') is not None else True,
